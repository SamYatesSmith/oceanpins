...
class Profile(models.Model):
    ...
    dive_school = models.CharField(max_length=100, choices=DIVE_SCHOOL_CHOICES, blank=True, null=True)
    ...
    profile_pic = CloudinaryField('image', default='https://res.cloudinary.com/dt6dg1u1o/image/upload/v1716999970/static/images/user_default.png')
